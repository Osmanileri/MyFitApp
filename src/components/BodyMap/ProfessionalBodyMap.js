...
const ProfessionalBodyMap = () => {
  ...
  const handleMusclePress = (muscle) => {
    ...
    Alert.alert(
      "Kas Grubu",
      `${muscle.id} seçildi! (Burada hareketler sayfasına yönlendirme yapılacak)`
    );
  };
          ...
          >
            <Pressable
              ...
              onPress={() => {
                ...
                setSelectedMuscle("abdominals");
                Vibration.vibrate(50);
              }}
            >
              <Image
                source={require("../../../assets/mark_abdominals.png")}
                style={[
                  styles.muscleMask,
                  {
                    tintColor:
                      selectedMuscle === "abdominals" ? "green" : "yellow",
                    opacity: 0.7,
                  },
                ]}
                resizeMode="contain"
            ...
            >
              <Image
                source={require("../../../assets/mark_biceps.png")}
                style={[
                  styles.muscleMask,
                  {
                    tintColor: selectedMuscle === "biceps" ? "green" : "yellow",
                    opacity: 0.7,
                  },
                ]}
                resizeMode="contain"
